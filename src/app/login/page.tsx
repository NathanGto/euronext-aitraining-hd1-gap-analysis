  ...
  return (
    <main className="mx-auto w-full max-w-md px-4 py-10">
      <section className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-[var(--muted)]">Access your saved market alerts and preferences.</p>
        ...
        <p className="mt-4 text-xs text-[var(--muted)]">
          Authentication backend is currently unavailable in this training environment.
        </p>
      </section>
    </main>
  );
